import { Button, Rating, Snackbar, Tab, Tabs, TextField, Typography } from "@mui/material"
...
const CreateProblem = () => {
  ...
  const onSubmit: SubmitHandler<problem> = (data : problem) => {
    ...
    axios.post("http://localhost:5000/problems/create", [data], {
      headers: {
            ...
            { value === 0 &&
              <>
                ...
                <div style={{
                  ...
                  <TextField label="Memory Limit in MBs"
                  ...
                  <TextField label="Time Limit in seconds"
                ...
                <div style={{
                  ...
                  <Typography variant="h4" style={{ color: "#fff" }}>Rating</Typography>
                  <Rating value={rating} defaultValue={0} max={10} onChange={(event, newValue) => {
            ...
            { value === 1 &&
              <div style={{
                ...
                <TextField label={`Test Case Output`}
                  multiline
                  rows={25}
                  {...register(`testcases.0.expected_output`, { required: true })}
                  sx={{
                    ...styleInput,
                    '& textarea': { 
                      color: '#fff',
            ...
            {[...Array(numberOfExtraTC)].map((_, i) => ( value == i + 2 &&
              <div key={i} style={{
                ...
                <TextField label={`Test Case #${i + 1} Input`}
                  multiline
                  rows={25}
                  {...register(`testcases.${i + 1}.input`, { required: true })}
                  sx={{
                    ...styleInput,
                    '& textarea': { 
                      color: '#fff',
                ...
                <TextField label={`Test Case #${i + 1} Output`}
                  multiline
                  rows={25}
                  {...register(`testcases.${i + 1}.expected_output`, { required: true })}
                  sx={{
                    ...styleInput,
                    '& textarea': { 
                      color: '#fff',
